...
namespace Vulkan {
Pipeline::Pipeline(Device& device, const std::string& vertFilePath, const std::string& fragFilePath, const PipelineConfigInfo& configInfo) : mDevice{device} {
...
#pragma endregion
	...
	if (vkCreateGraphicsPipelines(mDevice.get(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &mGraphicsPipeline) != VK_SUCCESS) {
